...
- **Make a pet:** [How to Make a Pet](how-to-make-a-custom-pet) walks through building one from scratch.
- **Plugin config:** [Plugin Config](plugin-config) to customise the GUIs and pet entity.
- **Commands:** [Commands and Permissions](commands-and-permissions) for giving, resetting, and importing pets.